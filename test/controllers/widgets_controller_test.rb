...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { color: @widget.color, size: @widget.size, thickness: @widget.thickness } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { color: @widget.color, size: @widget.size, thickness: @widget.thickness } }
